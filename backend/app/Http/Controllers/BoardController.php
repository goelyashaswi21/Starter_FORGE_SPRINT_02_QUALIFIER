...
class BoardController extends Controller {
    public function index() { return Board::with(['lists.cards.tags', 'lists.cards.members', 'members', 'tags'])->get(); }
    public function store(Request $request) {
        $board = Board::create($request->validate(['name' => 'required', 'description' => 'nullable']));
        return response()->json($board, 201);
    }
    public function show(Board $board) { return $board->load(['lists.cards.tags', 'lists.cards.members', 'members', 'tags']); }
